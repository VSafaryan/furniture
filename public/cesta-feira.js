(function ($, document) {
  ...
  function submitForm(e) {
    ...
    var $form = $(e.currentTarget),
      ...
      // $id = $form.find('[data-cesta-feira-item-id]');
    ...
    $.jStorage.set( PRODUCTS_KEY, products );   //js add storage

    // console.log(products.Object.keys(),'ooooooooooooooooooooooooooooooooooooooooooo')
